 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.5.0-standalone.jar io.confluent.examples.streams.WordCountLambdaExample
 * }
 * </pre>
...
public class WordCount {
    ...
    static final String inputTopic = "wordcount-in2";
    static final String outputTopic = "wordcount-out2";

    /**
     * The Streams application as a whole can be launched like any normal Java application that has a `main()` method.
     */
    public static void main(final String[] args) {
        final String bootstrapServers = args.length > 0 ? args[0] : "18.135.249.38:9092";
        ...
        streams.setUncaughtExceptionHandler((t,e) -> System.out.println("error on "+t+"error is " + e));
